			...
			children: [{
				...
				},
				{
					...
					children: [{
							//题库
							path: '/lib_questions',
							component: resolve => require(['../components/QuestionsLib.vue'], resolve),
							meta: {
								title: '题库'
							}
						},
						{
							//资源库
							path: '/lib_resources',
							component: resolve => require(['../components/ResourcesLib.vue'], resolve),
							meta: {
								title: '资源库'
							}
						},
						{
							//活动库
							path: '/lib_activities',
							component: resolve => require(['../components/ActivitiesLib.vue'], resolve),
							meta: {
								title: '活动库'
							}
						}
